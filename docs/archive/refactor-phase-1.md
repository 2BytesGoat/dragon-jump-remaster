...
- [x] Update `docs/technical/architecture.md` with final autoload roster ✅ Done
- [x] Update `docs/design/release-plan.md` with locked V1.0 scope ✅ Done
- [x] Update `docs/project/decisions.md` ✅ Done
- [x] Create `docs/design/ai-training-mode.md`
- [x] Update `docs/future/shelved-features.md` to reflect what was removed vs deferred
