...
This checklist ensures all documentation files in the Dragon Jump Remaster project meet the standards outlined in the [[meta/process]] guidelines.
...
- [ ] Documentation file located in `docs/technical/`
- [ ] Properly organized — single-file systems use `docs/technical/system-name.md`, multi-file systems use a subfolder with `index.md`
- [ ] Each documentation file linked from its corresponding tracking entry in `docs/meta/tracking.md`
...
- [ ] Files properly linked in `docs/meta/tracking.md`
...
- [ ] Content follows the exact structure specified in [[meta/process]]
