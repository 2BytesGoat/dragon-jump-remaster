...
related:
  ...
  - "[[technical/save-system/game-data]]"
...
- [[technical/save-system/index]] - Primary system that updates and manages LevelData objects
- [[technical/save-system/game-data]] - Container that holds all LevelData objects in the levels dictionary
