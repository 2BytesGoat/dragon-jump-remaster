...
- [x] main.tscn - (Added documentation to /docs/main_system/main_system.md)

## Player System

- [x] src/scenes/player/player.gd - (Added documentation to /docs/player_system/player_system.md)
- [x] src/scenes/player/player.tscn - (Added documentation to /docs/player_system/player_system.md)
- [x] src/scenes/player/ghost.gd - (Added documentation to /docs/player_system/player_system.md)
- [x] src/scenes/player/ghost.tscn - (Added documentation to /docs/player_system/player_system.md)
- [x] src/scenes/player/gapling_hook.gd - (Added documentation to /docs/player_system/player_system.md)
- [x] src/scenes/player/observer.gd - (Added documentation to /docs/player_system/player_system.md)
- [x] src/scenes/player/state_label.gd - (Added documentation to /docs/player_system/player_system.md)
...
- [x] src/scenes/level/level.gd - (Added documentation to /docs/level_system/level_system.md)
- [x] src/scenes/level/level.tscn - (Added documentation to /docs/level_system/level_system.md)
- [x] src/scenes/level/level_background.gd - (Added documentation to /docs/level_system/level_background_system.md)
- [x] src/scenes/level/level_wall_blend.gd - (Added documentation to /docs/level_system/level_wall_blend_system.md)
- [x] src/scenes/level/secrets_layer.gd - (Added documentation to /docs/level_system/secrets_layer_system.md)
- [x] src/scenes/level/terrain_layer.gd - (Added documentation to /docs/level_system/terrain_layer_system.md)
...
- [x] src/scripts/singletons/save_manager.gd - (Added documentation to /docs/save_system/save_system.md)
- [x] src/scripts/resources/game_data.gd - (Added documentation to /docs/save_system/game_data.md)
- [x] src/scripts/resources/level_data.gd - (Added documentation to /docs/save_system/level_data.md)
- [x] src/scripts/resources/campaing_level_data.gd - (Added documentation to /docs/save_system/campaing_level_data.md)
...
- [ ] src/ui/components/leaderboard.gd - (Documented in /docs/leaderboard_system/leaderboard_system.md)
- [ ] src/ui/components/leaderboard_entry.gd - (Documented in /docs/leaderboard_system/leaderboard_system.md)
...
- [x] docs/project_notes/project_notes.md - (Decision log and project audit notes)
