...
See [[tracking/sprints/sprint_2026_08_17]] for the full sprint plan and definition of done. See [[tracking/sprints/sprint_2026_08_31]] for Sprint 2 (the finish line).
...
[[tracking/sprints/sprint_2026_07_25]] (ML workshop competition) is closed. See its retrospective. ~8 days of untracked polish work after that sprint (arcade 3-lives logic skeleton, secret areas, powerup cards, parallax, grass) has been reconciled into [[tracking/backlog]].

## Where to find related planning

- Full backlog and phases: [[tracking/backlog]]
- Release plan and milestones: [[direction/release_plan]] § Release milestones
- Arcade design reference: [[direction/arcade_mode_design]]
- Sprint workflow and template: [[documentation_process]] § Sprint workflow, [[tracking/sprints/_template]]
- Previous sprint: [[tracking/sprints/sprint_2026_07_25]] and [[tracking/decisions]]
